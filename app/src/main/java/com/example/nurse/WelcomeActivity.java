...
//        };
        ...
        DriverWelcomeButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent DriverIntent = new Intent(WelcomeActivity.this, NurseLoginRegisterActivity.class);
        ...
        CustomerWelcomeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                Intent CustomerIntent = new Intent(WelcomeActivity.this, NurseLoginRegisterActivity.class);
