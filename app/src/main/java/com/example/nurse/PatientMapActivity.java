...
//        profilePic = findViewById(R.id.profile_image_driver);
        ...
        SettingsButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(PatientMapActivity.this, SettingsActivity.class);
        ...
        CallCabCarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                else
                {
                    ...
                    PickUpMarker = mMap.addMarker(new MarkerOptions().position(CustomerPickUpLocation).title("My Location").icon(BitmapDescriptorFactory.fromResource(R.drawable.patient)));
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        if(dataSnapshot.exists()  &&  requestType)
                        {
                            ...
                            DriverMarker = mMap.addMarker(new MarkerOptions().position(DriverLatLng).title("your driver is here").icon(BitmapDescriptorFactory.fromResource(R.drawable.nurse)));
                        }
                    }
    ...
    {
        Intent startPageIntent = new Intent(PatientMapActivity.this, WelcomeActivity.class);
