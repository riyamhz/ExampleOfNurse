...
public class NurseMapActivity extends AppCompatActivity implements OnMapReadyCallback,
...
//        profilePic = findViewById(R.id.profile_image_customer);
        ...
        mapFragment.getMapAsync(NurseMapActivity.this);
        ...
        SettingsDriverButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(NurseMapActivity.this, SettingsActivity.class);
        ...
        AssignedCustomerPickUpRefListner = AssignedCustomerPickUpRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    PickUpMarker = mMap.addMarker(new MarkerOptions().position(DriverLatLng).title("Customer PickUp Location").icon(BitmapDescriptorFactory.fromResource(R.drawable.nurse)));
                }
            }
    ...
    {
        Intent startPageIntent = new Intent(NurseMapActivity.this, WelcomeActivity.class);
